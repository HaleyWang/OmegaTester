...
public final class AnnoManageUtil {
    ...
    public static List<Class<?>> scan(String packageName, Class<? extends Annotation> annotation) {
        ...
        System.out.println("ssss1--> " + ss.size());
        return ss.stream().filter(it-> AnnotationUtils.findAnnotation(it, MyRequestImportAnnotation.class) != null).collect(Collectors.toList());

    }


    public static List<Class<?>> scan1(String packageName, Class<? extends Annotation> annotation) {
            ...
            if ("file".equals(protocol) || "jar".equals(protocol) ) {
                try {
                   ...
                   // System.out.println(filePath);
                    ...
                    getFilePathClasses(packageName, url.toURI(), classList, annotation);
